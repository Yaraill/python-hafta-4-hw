...
pygame.display.set_caption("Game Over Oyun")
...
start_message_1 = test_font.render("Press Space to JUMP, Use the ARROW KEYS to move!", False, (111,196,169))
start_message_1_rect = start_message_1.get_rect(center = (WIDTH / 2, 300)) 

start_message_2 = test_font.render("Press Space for START", False, (111,196,169))
...
while True:
    ...
    if game_active:
        ...
        score_surf = test_font.render(f"Score: {score}", True, "Red")
        ...
        if score > 0: 
            game_over_text = test_font.render("GAME OVER!", False, (255, 0, 0))
            game_over_rect = game_over_text.get_rect(center=(WIDTH / 2, player_stand_rect.bottom + 30))
            screen.blit(game_over_text, game_over_rect)

            final_score_text = test_font.render(f"Your Score: {score}", False, (111, 196, 169))
            final_score_rect = final_score_text.get_rect(center=(WIDTH / 2, game_over_rect.bottom + 20)) 
            screen.blit(final_score_text, final_score_rect)
            
            restart_message_text = test_font.render("Press Space for START", False, (111, 196, 169))
